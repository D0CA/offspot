import {
  ...
  Texture,
  groupD8
} from "./chunk-YM7HBQL2.js";
import "./chunk-G3PMV62Z.js";

// node_modules/@md5crypt/dragonbones-pixi/lib/core/BaseObject.js
var BaseObject = class _BaseObject {
  constructor() {
    this.hashCode = _BaseObject._hashCode++;
    this._isInPool = false;
  }
  static _returnObject(object) {
    const classType = object.constructor.toString();
    const maxCount = classType in _BaseObject._maxCountMap ? _BaseObject._maxCountMap[classType] : _BaseObject._defaultMaxCount;
    const pool = _BaseObject._poolsMap[classType] = _BaseObject._poolsMap[classType] || [];
  ...
  static setMaxCount(objectConstructor, maxCount) {
    ...
    if (objectConstructor !== null) {
      ...
      const pool = classType in _BaseObject._poolsMap ? _BaseObject._poolsMap[classType] : null;
      if (pool !== null && pool.length > maxCount) {
        pool.length = maxCount;
      }
      _BaseObject._maxCountMap[classType] = maxCount;
    } else {
      _BaseObject._defaultMaxCount = maxCount;
      for (let classType in _BaseObject._poolsMap) {
        const pool = _BaseObject._poolsMap[classType];
        if (pool.length > maxCount) {
          pool.length = maxCount;
        }
        if (classType in _BaseObject._maxCountMap) {
          _BaseObject._maxCountMap[classType] = maxCount;
        }
      }
    }
  ...
  static clearPool(objectConstructor = null) {
    if (objectConstructor !== null) {
      ...
      for (let k in _BaseObject._poolsMap) {
        const pool = _BaseObject._poolsMap[k];
        pool.length = 0;
      }
    }
  }
  ...
  static borrowObject(objectConstructor) {
    ...
    const pool = classType in _BaseObject._poolsMap ? _BaseObject._poolsMap[classType] : null;
    if (pool !== null && pool.length > 0) {
      const object2 = pool.pop();
      object2._isInPool = false;
      return object2;
    }
  ...
  returnToPool() {
    this._onClear();
    _BaseObject._returnObject(this);
  }
};
...
// node_modules/@md5crypt/dragonbones-pixi/lib/event/EventObject.js
var EventObject = class _EventObject extends BaseObject {
  /**
   * @internal
   * @private
   */
  static actionDataToInstance(data, instance, armature) {
    if (data.type === 0) {
      instance.type = _EventObject.FRAME_EVENT;
    } else {
      instance.type = data.type === 10 ? _EventObject.FRAME_EVENT : _EventObject.SOUND_EVENT;
    }
...
// node_modules/@md5crypt/dragonbones-pixi/lib/core/DragonBones.js
var DragonBones = class {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/AnimationConfig.js
var AnimationConfig = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.boneMask = [];
  }
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/AnimationData.js
var AnimationData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.cachedFrames = [];
    this.boneTimelines = {};
...
var TimelineData = class extends BaseObject {
  static toString() {
...
var AnimationTimelineData = class extends TimelineData {
  static toString() {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/geom/ColorTransform.js
var ColorTransform = class {
  constructor(alphaMultiplier = 1, redMultiplier = 1, greenMultiplier = 1, blueMultiplier = 1, alphaOffset = 0, redOffset = 0, greenOffset = 0, blueOffset = 0) {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/geom/Matrix.js
var Matrix = class {
  /**
   * @private
   */
  ...
  transformRectangle(rectangle, delta = false) {
    ...
    const c = this.c;
    const d = this.d;
    const tx = delta ? 0 : this.tx;
    const ty = delta ? 0 : this.ty;
    const x = rectangle.x;
    const y = rectangle.y;
...
// node_modules/@md5crypt/dragonbones-pixi/lib/geom/Point.js
var Point = class {
  /**
...
// node_modules/@md5crypt/dragonbones-pixi/lib/geom/Rectangle.js
...
// node_modules/@md5crypt/dragonbones-pixi/lib/geom/Transform.js
var Transform = class _Transform {
  /**
   * @private
   */
  constructor(x = 0, y = 0, skew = 0, rotation = 0, scaleX = 1, scaleY = 1) {
    this.x = x;
    this.y = y;
    this.skew = skew;
...
var GeometryData = class {
  ...
  get vertexCount() {
    ...
    return intArray[
      this.offset + 0
      /* BinaryOffset.GeometryVertexCount */
    ];
  }
  get triangleCount() {
    const intArray = this.data.intArray;
...
var DisplayData = class extends BaseObject {
  constructor() {
    super(...arguments);
...
var ImageDisplayData = class extends DisplayData {
  constructor() {
    super(...arguments);
...
var ArmatureDisplayData = class extends DisplayData {
  constructor() {
    super(...arguments);
    this.actions = [];
  }
...
var MeshDisplayData = class extends DisplayData {
  constructor() {
    super(...arguments);
...
var BoundingBoxDisplayData = class extends DisplayData {
  constructor() {
    super(...arguments);
...
var PathDisplayData = class extends DisplayData {
  constructor() {
    super(...arguments);
    this.geometry = new GeometryData();
    this.curveLengths = [];
...
var WeightData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.bones = [];
  }
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/ArmatureData.js
var ArmatureData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.aabb = new Rectangle2();
    this.animationNames = [];
    this.sortedBones = [];
    this.sortedSlots = [];
    this.defaultActions = [];
...
var BoneData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.transform = new Transform();
    this.userData = null;
...
var SurfaceData = class extends BoneData {
  constructor() {
    super(...arguments);
    this.geometry = new GeometryData();
  }
...
var SlotData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.color = null;
    this.userData = null;
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/BoundingBoxData.js
var BoundingBoxData = class extends BaseObject {
  _onClear() {
    this.color = 0;
    this.width = 0;
    this.height = 0;
...
var RectangleBoundingBoxData = class _RectangleBoundingBoxData extends BoundingBoxData {
  static toString() {
  ...
  static rectangleIntersectsSegment(xA, yA, xB, yB, xMin, yMin, xMax, yMax, intersectionPointA = null, intersectionPointB = null, normalRadians = null) {
    ...
    let outcode0 = _RectangleBoundingBoxData._computeOutCode(xA, yA, xMin, yMin, xMax, yMax);
    let outcode1 = _RectangleBoundingBoxData._computeOutCode(xB, yB, xMin, yMin, xMax, yMax);
    while (true) {
      ...
      if (outcodeOut === outcode0) {
        xA = x;
        yA = y;
        outcode0 = _RectangleBoundingBoxData._computeOutCode(xA, yA, xMin, yMin, xMax, yMax);
        if (normalRadians !== null) {
        ...
        xB = x;
        yB = y;
        outcode1 = _RectangleBoundingBoxData._computeOutCode(xB, yB, xMin, yMin, xMax, yMax);
        if (normalRadians !== null) {
  ...
  intersectsSegment(xA, yA, xB, yB, intersectionPointA = null, intersectionPointB = null, normalRadians = null) {
    const widthH = this.width * 0.5;
    const heightH = this.height * 0.5;
    const intersectionCount = _RectangleBoundingBoxData.rectangleIntersectsSegment(xA, yA, xB, yB, -widthH, -heightH, widthH, heightH, intersectionPointA, intersectionPointB, normalRadians);
    return intersectionCount;
  }
};
var EllipseBoundingBoxData = class _EllipseBoundingBoxData extends BoundingBoxData {
  static toString() {
   ...
   */
  intersectsSegment(xA, yA, xB, yB, intersectionPointA = null, intersectionPointB = null, normalRadians = null) {
    const intersectionCount = _EllipseBoundingBoxData.ellipseIntersectsSegment(xA, yA, xB, yB, 0, 0, this.width * 0.5, this.height * 0.5, intersectionPointA, intersectionPointB, normalRadians);
    return intersectionCount;
  }
};
var PolygonBoundingBoxData = class _PolygonBoundingBoxData extends BoundingBoxData {
  constructor() {
    super(...arguments);
    this.vertices = [];
  }
  ...
  intersectsSegment(xA, yA, xB, yB, intersectionPointA = null, intersectionPointB = null, normalRadians = null) {
    ...
    if (RectangleBoundingBoxData.rectangleIntersectsSegment(xA, yA, xB, yB, this.x, this.y, this.x + this.width, this.y + this.height, null, null, null) !== 0) {
      intersectionCount = _PolygonBoundingBoxData.polygonIntersectsSegment(xA, yA, xB, yB, this.vertices, intersectionPointA, intersectionPointB, normalRadians);
    }
    return intersectionCount;
  }
};

// node_modules/@md5crypt/dragonbones-pixi/lib/model/CanvasData.js
var CanvasData = class extends BaseObject {
  static toString() {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/ConstraintData.js
var ConstraintData = class extends BaseObject {
  _onClear() {
    this.order = 0;
    this.name = "";
    this.type = 0;
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/DragonBonesData.js
var DragonBonesData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.frameIndices = [];
    this.cachedFrames = [];
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/SkinData.js
var SkinData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.displays = {};
  }
  ...
  addDisplay(slotName, value) {
    ...
    const slotDisplays = this.displays[slotName];
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/TextureAtlasData.js
var TextureAtlasData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.textures = {};
  }
...
var TextureData = class _TextureData extends BaseObject {
  constructor() {
    super(...arguments);
    this.region = new Rectangle2();
    this.frame = null;
  }
  ...
  copyFrom(value) {
    ...
    if (this.frame === null && value.frame !== null) {
      this.frame = _TextureData.createRectangle();
...
// node_modules/@md5crypt/dragonbones-pixi/lib/model/UserData.js
var UserData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.ints = [];
    this.floats = [];
...
var ActionData = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.data = null;
  }
...
// node_modules/@md5crypt/dragonbones-pixi/lib/animation/BaseTimelineState.js
var TimelineState = class extends BaseObject {
  _onClear() {
    this.dirty = false;
    this.playState = -1;
    ...
    if (this._actionTimeline !== null && this._frameCount <= 1) {
      ...
      if (playTimes > 0 && (passedTime >= totalTime || passedTime <= -totalTime)) {
        ...
        if (passedTime < 0) {
          ...
          this.currentTime = this.playState === 1 ? this._duration + 1e-6 : this._duration;
        }
      } else {
        if (this.playState !== 0 && this._animationState._playheadState === 3) {
          this.playState = 0;
  ...
  update(passedTime) {
    if (this._setCurrentTime(passedTime)) {
      if (this._frameCount > 1) {
        const timelineFrameIndex = Math.floor(this.currentTime * this._frameRate);
        ...
        this._frameIndex = 0;
        if (this._timelineData !== null) {
          this._frameOffset = this._animationData.frameOffset + this._timelineArray[
            this._timelineData.offset + 5
...
var TweenTimelineState = class _TweenTimelineState extends TimelineState {
  ...
  static _getEasingCurveValue(progress, samples, count, offset) {
    ...
    let toValue = 0;
    if (isOmited) {
      fromValue = valueIndex === 0 ? 0 : samples[offset + valueIndex - 1];
      toValue = valueIndex === segmentCount - 1 ? 1e4 : samples[offset + valueIndex];
    } else {
      fromValue = samples[offset + valueIndex - 1];
      toValue = samples[offset + valueIndex];
    }
    return (fromValue + (toValue - fromValue) * (progress * segmentCount - valueIndex)) * 1e-4;
  }
  _onClear() {
    super._onClear();
    this._tweenType = 0;
    ...
    if (this._frameCount > 1 && (this._frameIndex !== this._frameCount - 1 || this._animationState.playTimes === 0 || this._animationState.currentPlayTimes < this._animationState.playTimes - 1)) {
      ...
      if (this._isTween) {
        if (this._tweenType === 2) {
          ...
          this._tweenEasing = this._frameArray[
            this._frameOffset + 2
            /* BinaryOffset.FrameTweenEasingOrCurveSampleCount */
          ] * 0.01;
        }
      ...
      if (this._frameIndex === this._frameCount - 1) {
        ...
        const nextFrameOffset = this._animationData.frameOffset + this._timelineArray[this._timelineData.offset + 5 + this._frameIndex + 1];
        const frameDuration = this._frameArray[nextFrameOffset] * this._frameRateR - this._framePosition;
        if (frameDuration > 0) {
          this._frameDurationR = 1 / frameDuration;
        } else {
          this._frameDurationR = 0;
        }
      }
  ...
  _onUpdateFrame() {
    if (this._isTween) {
      ...
      if (this._tweenType === 2) {
        this._tweenProgress = _TweenTimelineState._getEasingCurveValue(
          this._tweenProgress,
          this._frameArray,
          this._curveCount,
          this._frameOffset + 3
          /* BinaryOffset.FrameCurveSamples */
        );
      } else if (this._tweenType !== 1) {
        this._tweenProgress = _TweenTimelineState._getEasingValue(this._tweenType, this._tweenProgress, this._tweenEasing);
      }
    }
  }
};
var SingleValueTimelineState = class extends TweenTimelineState {
  _onClear() {
    super._onClear();
    this._current = 0;
    this._difference = 0;
  ...
  _onArriveAtFrame() {
    ...
    if (this._timelineData !== null) {
      ...
      if (this._isTween) {
        const nextValueOffset = this._frameIndex === this._frameCount - 1 ? this._valueOffset + this._frameValueOffset : valueOffset + 1;
        if (valueScale === 1) {
...
var DoubleValueTimelineState = class extends TweenTimelineState {
  _onClear() {
    super._onClear();
    this._currentA = 0;
    this._currentB = 0;
  ...
  _onArriveAtFrame() {
    ...
    if (this._timelineData !== null) {
      ...
      if (this._isTween) {
        const nextValueOffset = this._frameIndex === this._frameCount - 1 ? this._valueOffset + this._frameValueOffset : valueOffset + 2;
        if (valueScale === 1) {
...
var MutilpleValueTimelineState = class extends TweenTimelineState {
  constructor() {
    super(...arguments);
    this._rd = [];
  }
  ...
  _onArriveAtFrame() {
    ...
    if (this._timelineData !== null) {
      ...
      if (this._isTween) {
        const nextValueOffset = this._frameIndex === this._frameCount - 1 ? this._valueOffset + this._frameValueOffset : valueOffset + valueCount;
        if (valueScale === 1) {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/animation/TimelineState.js
var ActionTimelineState = class extends TimelineState {
  static toString() {
  ...
  _onCrossFrame(frameIndex) {
    ...
    if (this._animationState.actionEnabled) {
      const frameOffset = this._animationData.frameOffset + this._timelineArray[this._timelineData.offset + 5 + frameIndex];
      ...
      for (let i = 0; i < actionCount; ++i) {
        ...
        if (action.type === 0) {
          ...
          const eventType = action.type === 10 ? EventObject.FRAME_EVENT : EventObject.SOUND_EVENT;
          if (action.type === 11 || eventDispatcher.hasDBEventListener(eventType)) {
            const eventObject = BaseObject.borrowObject(EventObject);
            eventObject.time = this._frameArray[frameOffset] / this._frameRate;
            eventObject.animationState = this._animationState;
            EventObject.actionDataToInstance(action, eventObject, this._armature);
          ...
          if (this._timelineArray !== null) {
            ...
            if (isReverse) {
              ...
              while (crossedFrameIndex >= 0) {
                const frameOffset = this._animationData.frameOffset + this._timelineArray[timelineData.offset + 5 + crossedFrameIndex];
...
var ZOrderTimelineState = class extends TimelineState {
  static toString() {
...
var BoneAllTimelineState = class extends MutilpleValueTimelineState {
  static toString() {
  ...
  blend(isDirty) {
    ...
    if (blendState.dirty > 1) {
      ...
      result.scaleX += (rd[4] - 1) * blendWeight;
      result.scaleY += (rd[5] - 1) * blendWeight;
    } else {
      result.x = rd[0] * blendWeight * valueScale;
      result.y = rd[1] * blendWeight * valueScale;
      result.rotation = rd[2] * blendWeight;
      result.skew = rd[3] * blendWeight;
      result.scaleX = (rd[4] - 1) * blendWeight + 1;
      result.scaleY = (rd[5] - 1) * blendWeight + 1;
    }
...
var BoneTranslateTimelineState = class extends DoubleValueTimelineState {
  static toString() {
...
var BoneRotateTimelineState = class extends DoubleValueTimelineState {
  static toString() {
...
var BoneScaleTimelineState = class extends DoubleValueTimelineState {
  static toString() {
  ...
  blend(isDirty) {
    ...
    const result = bone.animationPose;
    if (blendState.dirty > 1) {
      result.scaleX += (this._resultA - 1) * blendWeight;
      result.scaleY += (this._resultB - 1) * blendWeight;
    } else if (blendWeight !== 1) {
      result.scaleX = (this._resultA - 1) * blendWeight + 1;
      result.scaleY = (this._resultB - 1) * blendWeight + 1;
    } else {
...
var SurfaceTimelineState = class extends MutilpleValueTimelineState {
  static toString() {
  ...
  init(armature, animationState, timelineData) {
    ...
    if (this._timelineData !== null) {
      ...
      const frameIntOffset = this._animationData.frameIntOffset + this._timelineArray[
        this._timelineData.offset + 3
        /* BinaryOffset.TimelineFrameValueCount */
      ];
      this._valueOffset = this._animationData.frameFloatOffset;
      this._valueCount = frameIntArray[
        frameIntOffset + 2
        /* BinaryOffset.DeformValueCount */
      ];
      this._deformCount = frameIntArray[
        frameIntOffset + 1
        /* BinaryOffset.DeformCount */
      ];
      this._deformOffset = frameIntArray[
        frameIntOffset + 3
        /* BinaryOffset.DeformValueOffset */
      ];
      this._sameValueOffset = frameIntArray[
        frameIntOffset + 4
        /* BinaryOffset.DeformFloatOffset */
...
var AlphaTimelineState = class extends SingleValueTimelineState {
  static toString() {
  ...
  blend(isDirty) {
    ...
    if (blendState.dirty > 1) {
      ...
      if (alphaTarget._alpha > 1) {
        alphaTarget._alpha = 1;
      }
    } else {
      alphaTarget._alpha = this._result * blendWeight;
    }
...
var SlotDisplayTimelineState = class extends TimelineState {
  static toString() {
...
var SlotColorTimelineState = class extends TweenTimelineState {
  constructor() {
    super(...arguments);
    this._current = [0, 0, 0, 0, 0, 0, 0, 0];
    this._difference = [0, 0, 0, 0, 0, 0, 0, 0];
    this._result = [0, 0, 0, 0, 0, 0, 0, 0];
  }
  static toString() {
...
var SlotZIndexTimelineState = class extends SingleValueTimelineState {
  static toString() {
...
var DeformTimelineState = class extends MutilpleValueTimelineState {
  static toString() {
...
var IKConstraintTimelineState = class extends DoubleValueTimelineState {
  static toString() {
  ...
  _onUpdateFrame() {
    ...
    if (this._timelineData !== null) {
      ikConstraint._bendPositive = this._currentA > 0;
...
var AnimationProgressTimelineState = class extends SingleValueTimelineState {
  static toString() {
...
var AnimationWeightTimelineState = class extends SingleValueTimelineState {
  static toString() {
...
var AnimationParametersTimelineState = class extends DoubleValueTimelineState {
  static toString() {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/animation/AnimationState.js
var AnimationState = class extends BaseObject {
  constructor() {
    super(...arguments);
    this._boneMask = [];
    this._boneTimelines = [];
            ...
            for (const timelineData of timelineDatas) {
              switch (timelineData.type) {
                ...
                case 22: {
                  ...
                  const frameIntOffset = this._animationData.frameIntOffset + timelineArray[
                    timelineData.offset + 3
                    /* BinaryOffset.TimelineFrameValueCount */
                  ];
                  const frameIntArray = dragonBonesData.frameIntArray;
                  let geometryOffset = frameIntArray[
                    frameIntOffset + 0
                    /* BinaryOffset.DeformVertexOffset */
                  ];
                  if (geometryOffset < 0) {
                    geometryOffset += 65536;
                  }
  ...
  _advanceFadeTime(passedTime) {
    ...
    if (this._fadeTime >= this.fadeTotalTime) {
      ...
      this._fadeProgress = isFadeOut ? 1 - this._fadeTime / this.fadeTotalTime : this._fadeTime / this.fadeTotalTime;
    } else {
      this._fadeProgress = isFadeOut ? 1 : 0;
    }
    if (this._subFadeState > 0) {
      if (!isFadeOut) {
  ...
  advanceTime(passedTime, cacheFrameRate) {
    ...
    const isCacheEnabled = this._fadeState === 0 && cacheFrameRate > 0;
    ...
    if (isCacheEnabled) {
      const internval = cacheFrameRate * 2;
    ...
    if (isCacheEnabled) {
      const cacheFrameIndex = Math.floor(this._actionTimeline.currentTime * cacheFrameRate);
    ...
    if (isUpdateTimeline) {
      ...
      if (this._animationTimelines.length > 0) {
        ...
        if (leftState !== null) {
          ...
          if (rightState) {
            rightState.weight = 1 - leftState.weight;
          }
        }
      }
    }
  ...
  fadeOut(fadeOutTime, pausePlayhead = true) {
    ...
    if (this._fadeState > 0) {
      ...
      for (const timeline of this._animationTimelines) {
        ...
        animaitonState.fadeOut(999999, true);
      }
    }
    this.displayControl = false;
      ...
      if (currentBone !== null) {
        ...
        if (this._boneMask.length > 0) {
          for (const bone of bones) {
            const index2 = this._boneMask.indexOf(bone.name);
...
var BlendState = class extends BaseObject {
  static toString() {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/animation/Animation.js
var Animation = class extends BaseObject {
  constructor() {
    super(...arguments);
  ...
  playConfig(animationConfig) {
    ...
    if (animationConfig.fadeOutMode === 5) {
      for (const animationState2 of this._animationStates) {
        if (animationState2._fadeState < 1 && animationState2.layer === animationConfig.layer && animationState2.animationData === animationData) {
          return animationState2;
        }
      }
    }
    if (this._animationStates.length === 0) {
      animationConfig.fadeInTime = 0;
    } else if (animationConfig.fadeInTime < 0) {
      animationConfig.fadeInTime = animationData.fadeInTime;
    }
    if (animationConfig.fadeOutTime < 0) {
      animationConfig.fadeOutTime = animationConfig.fadeInTime;
    }
    if (animationConfig.timeScale <= -100) {
      animationConfig.timeScale = 1 / animationData.scale;
    }
    if (animationData.frameCount > 0) {
      if (animationConfig.position < 0) {
        ...
        animationConfig.position -= 1e-6;
      } else if (animationConfig.position > animationData.duration) {
        animationConfig.position %= animationData.duration;
      }
      if (animationConfig.duration > 0 && animationConfig.position + animationConfig.duration > animationData.duration) {
    ...
    if (!this._armature._lockUpdate && animationConfig.fadeInTime <= 0) {
      this.advanceTime(0);
    }
  ...
  gotoAndPlayByFrame(animationName, frame = 0, playTimes = -1) {
    ...
    if (animationData !== null) {
      this._animationConfig.position = animationData.frameCount > 0 ? animationData.duration * frame / animationData.frameCount : 0;
    }
    return this.playConfig(this._animationConfig);
  }
  /**
  ...
  gotoAndPlayByProgress(animationName, progress = 0, playTimes = -1) {
    ...
    const animationData = animationName in this._animations ? this._animations[animationName] : null;
    if (animationData !== null) {
      this._animationConfig.position = animationData.duration * (progress > 0 ? progress : 0);
    }
    return this.playConfig(this._animationConfig);
  }
  /**
...
// node_modules/@md5crypt/dragonbones-pixi/lib/animation/WorldClock.js
var WorldClock = class {
  /**
...
// node_modules/@md5crypt/dragonbones-pixi/lib/armature/Armature.js
var Armature = class _Armature extends BaseObject {
  constructor() {
    super(...arguments);
    this.stopped = false;
    this._bones = [];
  ...
  static _onSortSlots(a, b) {
    return a._zIndex * 1e3 + a._zOrder > b._zIndex * 1e3 + b._zOrder ? 1 : -1;
  }
  _onClear() {
    if (this._clock !== null) {
  ...
  advanceTime(passedTime) {
    ...
    if (this._slotsDirty || this._zIndexDirty) {
      this._slots.sort(_Armature._onSortSlots);
...
// node_modules/@md5crypt/dragonbones-pixi/lib/armature/TransformObject.js
var TransformObject = class extends BaseObject {
  constructor() {
    super(...arguments);
...
// node_modules/@md5crypt/dragonbones-pixi/lib/armature/Bone.js
var Bone = class extends TransformObject {
  constructor() {
    super(...arguments);
  ...
  _updateGlobalTransformMatrix(isCache) {
    ...
    if (inherit) {
      const isSurface = parent._boneData.type === 1;
...
// node_modules/@md5crypt/dragonbones-pixi/lib/armature/Constraint.js
var Constraint = class extends BaseObject {
  _onClear() {
    this._armature = null;
    this._target = null;
    this._root = null;
...
var IKConstraint = class extends Constraint {
  static toString() {
...
var PathConstraint = class extends Constraint {
  constructor() {
    super(...arguments);
    this._bones = [];
    this._spaces = [];
  ...
  _updatePathVertices(verticesData) {
    ...
    const pathVertexCount = intArray[
      pathOffset + 0
      /* BinaryOffset.GeometryVertexCount */
    ];
    const pathVertexOffset = intArray[
      pathOffset + 2
    ...
    if (weightData === null) {
      ...
      for (let i = 0, iV2 = pathVertexOffset; i < pathVertexCount; i += 2) {
        const vx = floatArray[iV2++] * scale;
        const vy = floatArray[iV2++] * scale;
    ...
    const floatOffset = intArray[
      weightOffset + 1
      /* BinaryOffset.WeigthFloatOffset */
    ];
    let iV = floatOffset;
    let iB = weightOffset + 2 + weightBoneCount;
  ...
  _computeBezierCurve(pathDisplayDta, spaceCount, tangents, percentPosition, percentSpacing) {
    ...
    const vertexCount = intArray[
      pathDisplayDta.geometry.offset + 0
      /* BinaryOffset.GeometryVertexCount */
    ];
  ...
  update() {
    ...
    const isLengthMode = spacingMode === 0;
    const isChainScaleMode = rotateMode === 2;
    const isTangentMode = rotateMode === 0;
...
// node_modules/@md5crypt/dragonbones-pixi/lib/armature/Slot.js
var DisplayFrame = class extends BaseObject {
  constructor() {
    super(...arguments);
    this.deformVertices = [];
  }
...
var Slot = class _Slot extends TransformObject {
  constructor() {
    super(...arguments);
  ...
  _updateDisplayData() {
    ...
    if (this._displayFrame !== prevDisplayFrame || this._geometryData !== prevGeometryData || this._textureData !== prevTextureData) {
      if (this._geometryData === null && this._textureData !== null) {
        const imageDisplayData = displayData !== null && displayData.type === 0 ? displayData : rawDisplayData;
        ...
        if (rawDisplayData !== null && imageDisplayData !== rawDisplayData) {
          rawDisplayData.transform.toMatrix(_Slot._helpMatrix);
          _Slot._helpMatrix.invert();
          _Slot._helpMatrix.transformPoint(0, 0, _Slot._helpPoint);
          this._pivotX -= _Slot._helpPoint.x;
          this._pivotY -= _Slot._helpPoint.y;
          imageDisplayData.transform.toMatrix(_Slot._helpMatrix);
          _Slot._helpMatrix.invert();
          _Slot._helpMatrix.transformPoint(0, 0, _Slot._helpPoint);
          this._pivotX += _Slot._helpPoint.x;
          this._pivotY += _Slot._helpPoint.y;
  ...
  _updateGlobalTransformMatrix(isCache) {
    const parentMatrix = this._parent._boneData.type === 0 ? this._parent.globalTransformMatrix : this._parent._getGlobalTransformMatrix(this.global.x, this.global.y);
  ...
  update(cacheFrameIndex) {
    ...
    if (this._geometryData !== null && this._display === this._meshDisplay) {
      ...
      const isSurface = this._parent._boneData.type !== 0;
      if (this._verticesDirty || isSkinned && this._isBonesUpdate() || isSurface && this._parent._childrenTransformDirty) {
        this._verticesDirty = false;
        this._updateMesh();
      }
  ...
  replaceDisplay(value, index = -1) {
    ...
    if (displayFrame.display !== value) {
      ...
      if (prevDisplay !== null && prevDisplay !== this._rawDisplay && prevDisplay !== this._meshDisplay && !this._hasDisplay(prevDisplay)) {
        if (prevDisplay instanceof Armature) {
        } else {
          this._disposeDisplay(prevDisplay, true);
        }
      }
      if (value !== null && value !== this._rawDisplay && value !== this._meshDisplay && !this._hasDisplay(prevDisplay) && !(value instanceof Armature)) {
  ...
  containsPoint(x, y) {
    ...
    _Slot._helpMatrix.copyFrom(this.globalTransformMatrix);
    _Slot._helpMatrix.invert();
    _Slot._helpMatrix.transformPoint(x, y, _Slot._helpPoint);
    return this._boundingBoxData.containsPoint(_Slot._helpPoint.x, _Slot._helpPoint.y);
  }
  /**
  ...
  intersectsSegment(xA, yA, xB, yB, intersectionPointA = null, intersectionPointB = null, normalRadians = null) {
    ...
    _Slot._helpMatrix.copyFrom(this.globalTransformMatrix);
    _Slot._helpMatrix.invert();
    _Slot._helpMatrix.transformPoint(xA, yA, _Slot._helpPoint);
    xA = _Slot._helpPoint.x;
    yA = _Slot._helpPoint.y;
    _Slot._helpMatrix.transformPoint(xB, yB, _Slot._helpPoint);
    xB = _Slot._helpPoint.x;
    yB = _Slot._helpPoint.y;
    ...
    if (intersectionCount > 0) {
      ...
      if (normalRadians !== null) {
        this.globalTransformMatrix.transformPoint(Math.cos(normalRadians.x), Math.sin(normalRadians.x), _Slot._helpPoint, true);
        normalRadians.x = Math.atan2(_Slot._helpPoint.y, _Slot._helpPoint.x);
        this.globalTransformMatrix.transformPoint(Math.cos(normalRadians.y), Math.sin(normalRadians.y), _Slot._helpPoint, true);
        normalRadians.y = Math.atan2(_Slot._helpPoint.y, _Slot._helpPoint.x);
      }
    }
    return intersectionCount;
  }
...
// node_modules/@md5crypt/dragonbones-pixi/lib/armature/Surface.js
var Surface = class _Surface extends Bone {
  constructor() {
    super(...arguments);
    this._vertices = [];
  ...
  _getGlobalTransformMatrix(x, y) {
    ...
    const helpMatrix = _Surface._helpMatrix;
    if (x < -lA) {
      if (y < -lA || y >= lA) {
        return this.globalTransformMatrix;
      }
      ...
      if (matrices[matrixIndex] > 0) {
        ...
        const vertices = this._vertices;
        if (isDown) {
          this._getAffineTransform(-lA, pY + dY, lB - lA, dY, vertices[vertexIndex + segmentXD + 2], vertices[vertexIndex + segmentXD + 3], sX + ddX, sY + ddY, vertices[vertexIndex], vertices[vertexIndex + 1], _Surface._helpTransform, helpMatrix, true);
        } else {
          this._getAffineTransform(-lB, pY, lB - lA, dY, sX, sY, vertices[vertexIndex], vertices[vertexIndex + 1], sX + ddX, sY + ddY, _Surface._helpTransform, helpMatrix, false);
        }
      ...
      if (matrices[matrixIndex] > 0) {
        ...
        const vertices = this._vertices;
        if (isDown) {
          this._getAffineTransform(lB, pY + dY, lB - lA, dY, sX + ddX, sY + ddY, vertices[vertexIndex + segmentXD + 2], vertices[vertexIndex + segmentXD + 3], sX, sY, _Surface._helpTransform, helpMatrix, true);
        } else {
          this._getAffineTransform(lA, pY, lB - lA, dY, vertices[vertexIndex], vertices[vertexIndex + 1], sX, sY, vertices[vertexIndex + segmentXD + 2], vertices[vertexIndex + segmentXD + 3], _Surface._helpTransform, helpMatrix, false);
        }
        matrices[matrixIndex] = 1;
        matrices[matrixIndex + 1] = helpMatrix.a;
        matrices[matrixIndex + 2] = helpMatrix.b;
      ...
      if (matrices[matrixIndex] > 0) {
        ...
        const vertices = this._vertices;
        if (isDown) {
          this._getAffineTransform(pX + dX, -lA, dX, lB - lA, vertices[vertexIndex + 2], vertices[vertexIndex + 3], vertices[vertexIndex], vertices[vertexIndex + 1], sX + ddX, sY + ddY, _Surface._helpTransform, helpMatrix, true);
        } else {
          this._getAffineTransform(pX, -lB, dX, lB - lA, sX, sY, sX + ddX, sY + ddY, vertices[vertexIndex], vertices[vertexIndex + 1], _Surface._helpTransform, helpMatrix, false);
        }
        matrices[matrixIndex] = 1;
        matrices[matrixIndex + 1] = helpMatrix.a;
        matrices[matrixIndex + 2] = helpMatrix.b;
      ...
      if (matrices[matrixIndex] > 0) {
        ...
        const vertices = this._vertices;
        if (isDown) {
          this._getAffineTransform(pX + dX, lB, dX, lB - lA, sX + ddX, sY + ddY, sX, sY, vertices[vertexIndex + 2], vertices[vertexIndex + 3], _Surface._helpTransform, helpMatrix, true);
        } else {
          this._getAffineTransform(pX, lA, dX, lB - lA, vertices[vertexIndex], vertices[vertexIndex + 1], vertices[vertexIndex + 2], vertices[vertexIndex + 3], sX, sY, _Surface._helpTransform, helpMatrix, false);
        }
        matrices[matrixIndex] = 1;
        matrices[matrixIndex + 1] = helpMatrix.a;
        matrices[matrixIndex + 2] = helpMatrix.b;
      ...
      if (matrices[matrixIndex] > 0) {
        ...
        const vertices = this._vertices;
        if (isDown) {
          this._getAffineTransform(pX + dX, pY + dY, dX, dY, vertices[vertexIndex + segmentXD + 4], vertices[vertexIndex + segmentXD + 5], vertices[vertexIndex + segmentXD + 2], vertices[vertexIndex + segmentXD + 3], vertices[vertexIndex + 2], vertices[vertexIndex + 3], _Surface._helpTransform, helpMatrix, true);
        } else {
          this._getAffineTransform(pX, pY, dX, dY, vertices[vertexIndex], vertices[vertexIndex + 1], vertices[vertexIndex + 2], vertices[vertexIndex + 3], vertices[vertexIndex + segmentXD + 2], vertices[vertexIndex + segmentXD + 3], _Surface._helpTransform, helpMatrix, false);
        }
        matrices[matrixIndex] = 1;
        matrices[matrixIndex + 1] = helpMatrix.a;
        matrices[matrixIndex + 2] = helpMatrix.b;
  ...
  init(surfaceData, armatureValue) {
    ...
    const vertexCount = this._armature.armatureData.parent.intArray[
      surfaceData.geometry.offset + 0
      /* BinaryOffset.GeometryVertexCount */
    ];
    const lB = 1e3;
    const lA = 200;
    this._dX = lA * 2 / segmentX;
    this._dY = lA * 2 / segmentY;
  ...
  update(cacheFrameIndex) {
    ...
    if (this._transformDirty) {
      ...
      const helpPoint = _Surface._helpPoint;
...
// node_modules/@md5crypt/dragonbones-pixi/lib/parser/DataParser.js
...
// node_modules/@md5crypt/dragonbones-pixi/lib/parser/ObjectDataParser.js
var ObjectDataParser = class _ObjectDataParser extends DataParser {
  constructor() {
    super(...arguments);
  ...
  _parseActionDataInFrame(rawData, frameStart, bone, slot) {
    if (DataParser.EVENT in rawData) {
      this._mergeActionFrame(rawData[DataParser.EVENT], frameStart, 10, bone, slot);
    }
    if (DataParser.SOUND in rawData) {
      this._mergeActionFrame(rawData[DataParser.SOUND], frameStart, 11, bone, slot);
    }
    if (DataParser.ACTION in rawData) {
      this._mergeActionFrame(rawData[DataParser.ACTION], frameStart, 0, bone, slot);
    }
    if (DataParser.EVENTS in rawData) {
      this._mergeActionFrame(rawData[DataParser.EVENTS], frameStart, 10, bone, slot);
    }
    if (DataParser.ACTIONS in rawData) {
      this._mergeActionFrame(rawData[DataParser.ACTIONS], frameStart, 0, bone, slot);
    }
  }
  ...
  _parseArmature(rawData, scale) {
    ...
    armature.name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
    armature.frameRate = _ObjectDataParser._getNumber(rawData, DataParser.FRAME_RATE, this._data.frameRate);
    ...
    if (DataParser.TYPE in rawData && typeof rawData[DataParser.TYPE] === "string") {
      ...
      armature.type = _ObjectDataParser._getNumber(
        rawData,
        DataParser.TYPE,
        0
    ...
    if (DataParser.CANVAS in rawData) {
      ...
      canvas.color = _ObjectDataParser._getNumber(rawCanvas, DataParser.COLOR, 0);
      canvas.x = _ObjectDataParser._getNumber(rawCanvas, DataParser.X, 0) * armature.scale;
      canvas.y = _ObjectDataParser._getNumber(rawCanvas, DataParser.Y, 0) * armature.scale;
      canvas.width = _ObjectDataParser._getNumber(rawCanvas, DataParser.WIDTH, 0) * armature.scale;
      canvas.height = _ObjectDataParser._getNumber(rawCanvas, DataParser.HEIGHT, 0) * armature.scale;
      armature.canvas = canvas;
    }
    if (DataParser.AABB in rawData) {
      const rawAABB = rawData[DataParser.AABB];
      armature.aabb.x = _ObjectDataParser._getNumber(rawAABB, DataParser.X, 0) * armature.scale;
      armature.aabb.y = _ObjectDataParser._getNumber(rawAABB, DataParser.Y, 0) * armature.scale;
      armature.aabb.width = _ObjectDataParser._getNumber(rawAABB, DataParser.WIDTH, 0) * armature.scale;
      armature.aabb.height = _ObjectDataParser._getNumber(rawAABB, DataParser.HEIGHT, 0) * armature.scale;
    }
    if (DataParser.BONE in rawData) {
      const rawBones = rawData[DataParser.BONE];
      for (const rawBone of rawBones) {
        const parentName = _ObjectDataParser._getString(rawBone, DataParser.PARENT, "");
    ...
    for (let i = 0, l = this._cacheRawMeshes.length; i < l; ++i) {
      const rawData2 = this._cacheRawMeshes[i];
      const shareName = _ObjectDataParser._getString(rawData2, DataParser.SHARE, "");
      if (shareName.length === 0) {
        continue;
      }
      let skinName = _ObjectDataParser._getString(rawData2, DataParser.SKIN, DataParser.DEFAULT_NAME);
      if (skinName.length === 0) {
        skinName = DataParser.DEFAULT_NAME;
      }
      const shareMesh = armature.getMesh(skinName, "", shareName);
      if (shareMesh === null) {
        continue;
      }
    ...
    if (DataParser.DEFAULT_ACTIONS in rawData) {
      const actions = this._parseActionData(rawData[DataParser.DEFAULT_ACTIONS], 0, null, null);
      for (const action of actions) {
    ...
    if (DataParser.ACTIONS in rawData) {
      const actions = this._parseActionData(rawData[DataParser.ACTIONS], 0, null, null);
      for (const action of actions) {
  ...
  _parseBone(rawData) {
    ...
    if (DataParser.TYPE in rawData && typeof rawData[DataParser.TYPE] === "string") {
      ...
      type = _ObjectDataParser._getNumber(
        rawData,
        DataParser.TYPE,
        0
        /* BoneType.Bone */
    ...
    if (type === 0) {
      ...
      bone.inheritTranslation = _ObjectDataParser._getBoolean(rawData, DataParser.INHERIT_TRANSLATION, true);
      bone.inheritRotation = _ObjectDataParser._getBoolean(rawData, DataParser.INHERIT_ROTATION, true);
      bone.inheritScale = _ObjectDataParser._getBoolean(rawData, DataParser.INHERIT_SCALE, true);
      bone.inheritReflection = _ObjectDataParser._getBoolean(rawData, DataParser.INHERIT_REFLECTION, true);
      bone.length = _ObjectDataParser._getNumber(rawData, DataParser.LENGTH, 0) * scale;
      bone.alpha = _ObjectDataParser._getNumber(rawData, DataParser.ALPHA, 1);
      bone.name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
    ...
    surface.alpha = _ObjectDataParser._getNumber(rawData, DataParser.ALPHA, 1);
    surface.name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
    surface.segmentX = _ObjectDataParser._getNumber(rawData, DataParser.SEGMENT_X, 0);
    surface.segmentY = _ObjectDataParser._getNumber(rawData, DataParser.SEGMENT_Y, 0);
    this._parseGeometry(rawData, surface.geometry);
    return surface;
  }
  _parseIKConstraint(rawData) {
    const bone = this._armature.getBone(_ObjectDataParser._getString(rawData, DataParser.BONE, ""));
    if (bone === null) {
      return null;
    }
    const target = this._armature.getBone(_ObjectDataParser._getString(rawData, DataParser.TARGET, ""));
    if (target === null) {
      return null;
    }
    const chain = _ObjectDataParser._getNumber(rawData, DataParser.CHAIN, 0);
    const constraint = BaseObject.borrowObject(IKConstraintData);
    constraint.scaleEnabled = _ObjectDataParser._getBoolean(rawData, DataParser.SCALE, false);
    constraint.bendPositive = _ObjectDataParser._getBoolean(rawData, DataParser.BEND_POSITIVE, true);
    constraint.weight = _ObjectDataParser._getNumber(rawData, DataParser.WEIGHT, 1);
    constraint.name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
    constraint.type = 0;
  ...
  _parsePathConstraint(rawData) {
    const target = this._armature.getSlot(_ObjectDataParser._getString(rawData, DataParser.TARGET, ""));
    if (target === null) {
      return null;
    }
    ...
    const targetDisplay = defaultSkin.getDisplay(target.name, _ObjectDataParser._getString(rawData, DataParser.TARGET_DISPLAY, target.name));
    ...
    constraint.positionMode = DataParser._getPositionMode(_ObjectDataParser._getString(rawData, DataParser.POSITION_MODE, ""));
    constraint.spacingMode = DataParser._getSpacingMode(_ObjectDataParser._getString(rawData, DataParser.SPACING_MODE, ""));
    constraint.rotateMode = DataParser._getRotateMode(_ObjectDataParser._getString(rawData, DataParser.ROTATE_MODE, ""));
    constraint.position = _ObjectDataParser._getNumber(rawData, DataParser.POSITION, 0);
    constraint.spacing = _ObjectDataParser._getNumber(rawData, DataParser.SPACING, 0);
    constraint.rotateOffset = _ObjectDataParser._getNumber(rawData, DataParser.ROTATE_OFFSET, 0);
    constraint.rotateMix = _ObjectDataParser._getNumber(rawData, DataParser.ROTATE_MIX, 1);
    constraint.translateMix = _ObjectDataParser._getNumber(rawData, DataParser.TRANSLATE_MIX, 1);
  ...
  _parseSlot(rawData, zOrder) {
    ...
    slot.displayIndex = _ObjectDataParser._getNumber(rawData, DataParser.DISPLAY_INDEX, 0);
    slot.zOrder = zOrder;
    slot.zIndex = _ObjectDataParser._getNumber(rawData, DataParser.Z_INDEX, 0);
    slot.alpha = _ObjectDataParser._getNumber(rawData, DataParser.ALPHA, 1);
    slot.name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
    slot.parent = this._armature.getBone(_ObjectDataParser._getString(rawData, DataParser.PARENT, ""));
    if (DataParser.BLEND_MODE in rawData && typeof rawData[DataParser.BLEND_MODE] === "string") {
      ...
      slot.blendMode = _ObjectDataParser._getNumber(
        rawData,
    ...
    if (DataParser.ACTIONS in rawData) {
      this._slotChildActions[slot.name] = this._parseActionData(rawData[DataParser.ACTIONS], 0, null, null);
    }
    return slot;
  }
  _parseSkin(rawData) {
    const skin = BaseObject.borrowObject(SkinData);
    skin.name = _ObjectDataParser._getString(rawData, DataParser.NAME, DataParser.DEFAULT_NAME);
    ...
    if (DataParser.SLOT in rawData) {
      ...
      this._skin = skin;
      for (const rawSlot of rawSlots) {
        const slotName = _ObjectDataParser._getString(rawSlot, DataParser.NAME, "");
  ...
  _parseDisplay(rawData) {
    const name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
    const path = _ObjectDataParser._getString(rawData, DataParser.PATH, "");
    let type = 0;
    let display = null;
    if (DataParser.TYPE in rawData && typeof rawData[DataParser.TYPE] === "string") {
      type = DataParser._getDisplayType(rawData[DataParser.TYPE]);
    } else {
      type = _ObjectDataParser._getNumber(rawData, DataParser.TYPE, type);
    }
    switch (type) {
      case 0: {
      ...
      case 2: {
        ...
        meshDisplay.geometry.inheritDeform = _ObjectDataParser._getBoolean(rawData, DataParser.INHERIT_DEFORM, true);
      ...
      case 4: {
        ...
        pathDisplay.closed = _ObjectDataParser._getBoolean(rawData, DataParser.CLOSED, false);
        pathDisplay.constantSpeed = _ObjectDataParser._getBoolean(rawData, DataParser.CONSTANT_SPEED, false);
  ...
  _parsePivot(rawData, display) {
    if (DataParser.PIVOT in rawData) {
      ...
      display.pivot.x = _ObjectDataParser._getNumber(rawPivot, DataParser.X, 0);
      display.pivot.y = _ObjectDataParser._getNumber(rawPivot, DataParser.Y, 0);
    } else {
      display.pivot.x = 0.5;
      display.pivot.y = 0.5;
    }
  ...
  _parseBoundingBox(rawData) {
    ...
    if (DataParser.SUB_TYPE in rawData && typeof rawData[DataParser.SUB_TYPE] === "string") {
      ...
      type = _ObjectDataParser._getNumber(rawData, DataParser.SUB_TYPE, type);
    }
    switch (type) {
      case 0:
    ...
    if (boundingBox !== null) {
      boundingBox.color = _ObjectDataParser._getNumber(rawData, DataParser.COLOR, 0);
      if (boundingBox.type === 0 || boundingBox.type === 1) {
        boundingBox.width = _ObjectDataParser._getNumber(rawData, DataParser.WIDTH, 0);
        boundingBox.height = _ObjectDataParser._getNumber(rawData, DataParser.HEIGHT, 0);
      }
    }
    return boundingBox;
  }
  ...
  _parseAnimation(rawData) {
    ...
    animation.blendType = DataParser._getAnimationBlendType(_ObjectDataParser._getString(rawData, DataParser.BLEND_TYPE, ""));
    animation.frameCount = _ObjectDataParser._getNumber(rawData, DataParser.DURATION, 0);
    animation.playTimes = _ObjectDataParser._getNumber(rawData, DataParser.PLAY_TIMES, 1);
    animation.duration = animation.frameCount / this._armature.frameRate;
    animation.fadeInTime = _ObjectDataParser._getNumber(rawData, DataParser.FADE_IN_TIME, 0);
    animation.scale = _ObjectDataParser._getNumber(rawData, DataParser.SCALE, 1);
    animation.name = _ObjectDataParser._getString(rawData, DataParser.NAME, DataParser.DEFAULT_NAME);
    ...
    if (DataParser.FRAME in rawData) {
      ...
      if (keyFrameCount > 0) {
        for (let i = 0, frameStart = 0; i < keyFrameCount; ++i) {
          ...
          frameStart += _ObjectDataParser._getNumber(rawFrame, DataParser.DURATION, 1);
        }
      }
    }
    if (DataParser.Z_ORDER in rawData) {
      this._animation.zOrderTimeline = this._parseTimeline(rawData[DataParser.Z_ORDER], null, DataParser.FRAME, 1, 0, 0, this._parseZOrderFrame);
    }
    if (DataParser.BONE in rawData) {
    ...
    if (DataParser.FFD in rawData) {
      ...
      for (const rawTimeline of rawTimelines) {
        let skinName = _ObjectDataParser._getString(rawTimeline, DataParser.SKIN, DataParser.DEFAULT_NAME);
        const slotName = _ObjectDataParser._getString(rawTimeline, DataParser.SLOT, "");
        const displayName = _ObjectDataParser._getString(rawTimeline, DataParser.NAME, "");
        if (skinName.length === 0) {
          skinName = DataParser.DEFAULT_NAME;
        }
        ...
        const timeline = this._parseTimeline(rawTimeline, null, DataParser.FRAME, 22, 2, 0, this._parseSlotDeformFrame);
        if (timeline !== null) {
    ...
    if (DataParser.IK in rawData) {
      ...
      for (const rawTimeline of rawTimelines) {
        const constraintName = _ObjectDataParser._getString(rawTimeline, DataParser.NAME, "");
        const constraint = this._armature.getConstraint(constraintName);
        if (constraint === null) {
          continue;
        }
        const timeline = this._parseTimeline(rawTimeline, null, DataParser.FRAME, 30, 1, 2, this._parseIKConstraintFrame);
        if (timeline !== null) {
    ...
    if (DataParser.TIMELINE in rawData) {
      ...
      for (const rawTimeline of rawTimelines) {
        const timelineType = _ObjectDataParser._getNumber(
          rawTimeline,
          DataParser.TYPE,
          0
          /* TimelineType.Action */
        );
        const timelineName = _ObjectDataParser._getString(rawTimeline, DataParser.NAME, "");
        let timeline = null;
        switch (timelineType) {
          case 0:
            break;
          ...
          case 41:
            if (timelineType === 20) {
              ...
              if (timelineType === 23) {
                this._frameValueScale = 1;
              } else if (timelineType === 40 || timelineType === 41) {
                this._frameValueScale = 1e4;
              } else {
                this._frameValueScale = 100;
              }
            }
            if (timelineType === 60 || timelineType === 24 || timelineType === 41) {
              this._frameDefaultValue = 1;
            } else {
              this._frameDefaultValue = 0;
            }
            if (timelineType === 40 && animation.blendType !== 0) {
              timeline = BaseObject.borrowObject(AnimationTimelineData);
              const animaitonTimeline = timeline;
              animaitonTimeline.x = _ObjectDataParser._getNumber(rawTimeline, DataParser.X, 0);
              animaitonTimeline.y = _ObjectDataParser._getNumber(rawTimeline, DataParser.Y, 0);
            }
          ...
          case 30:
          case 42:
            if (timelineType === 30 || timelineType === 42) {
              this._frameValueType = 1;
              if (timelineType === 42) {
                this._frameValueScale = 1e4;
              } else {
            ...
            if (timelineType === 13 || timelineType === 30) {
              this._frameDefaultValue = 1;
            } else {
              this._frameDefaultValue = 0;
            }
          ...
          case 50: {
            ...
            timeline = this._parseTimeline(rawTimeline, null, DataParser.FRAME, timelineType, 2, 0, this._parseDeformFrame);
            this._geometry = null;
            break;
          }
          case 22: {
          ...
          case 21:
            timeline = this._parseTimeline(rawTimeline, null, DataParser.FRAME, timelineType, 1, 1, this._parseSlotColorFrame);
            break;
        }
        if (timeline !== null) {
          switch (timelineType) {
  ...
  _parseTimeline(rawData, rawFrames, framesKey, timelineType, frameValueType, frameValueCount, frameParser, timeline = null) {
    ...
    if (rawData !== null) {
      this._timelineArray[
        timelineOffset + 0
        /* BinaryOffset.TimelineScale */
      ] = Math.round(_ObjectDataParser._getNumber(rawData, DataParser.SCALE, 1) * 100);
      this._timelineArray[
        timelineOffset + 1
        /* BinaryOffset.TimelineOffset */
      ] = Math.round(_ObjectDataParser._getNumber(rawData, DataParser.OFFSET, 0) * 100);
    } else {
      this._timelineArray[
        timelineOffset + 0
        /* BinaryOffset.TimelineScale */
    ...
    if (keyFrameCount === 1) {
      ...
      const totalFrameCount = this._animation.frameCount + 1;
        ...
        if (frameStart + frameCount <= i && iK < keyFrameCount) {
          ...
          if (iK === keyFrameCount - 1) {
            ...
            if (rawFrame instanceof ActionFrame) {
              ...
              frameCount = _ObjectDataParser._getNumber(rawFrame, DataParser.DURATION, 1);
            }
          }
  ...
  _parseBoneTimeline(rawData) {
    const bone = this._armature.getBone(_ObjectDataParser._getString(rawData, DataParser.NAME, ""));
    if (bone === null) {
      return;
    }
    this._bone = bone;
    ...
    if (DataParser.TRANSLATE_FRAME in rawData) {
      this._frameDefaultValue = 0;
      this._frameValueScale = 1;
      const timeline = this._parseTimeline(rawData, null, DataParser.TRANSLATE_FRAME, 11, 2, 2, this._parseDoubleValueFrame);
      if (timeline !== null) {
    ...
    if (DataParser.ROTATE_FRAME in rawData) {
      this._frameDefaultValue = 0;
      this._frameValueScale = 1;
      const timeline = this._parseTimeline(rawData, null, DataParser.ROTATE_FRAME, 12, 2, 2, this._parseBoneRotateFrame);
      if (timeline !== null) {
        this._animation.addBoneTimeline(bone.name, timeline);
      }
    }
    if (DataParser.SCALE_FRAME in rawData) {
      this._frameDefaultValue = 1;
      this._frameValueScale = 1;
      const timeline = this._parseTimeline(rawData, null, DataParser.SCALE_FRAME, 13, 2, 2, this._parseBoneScaleFrame);
      if (timeline !== null) {
        this._animation.addBoneTimeline(bone.name, timeline);
      }
    }
    if (DataParser.FRAME in rawData) {
      const timeline = this._parseTimeline(rawData, null, DataParser.FRAME, 10, 2, 6, this._parseBoneAllFrame);
      if (timeline !== null) {
        this._animation.addBoneTimeline(bone.name, timeline);
      }
    }
  ...
  _parseSlotTimeline(rawData) {
    const slot = this._armature.getSlot(_ObjectDataParser._getString(rawData, DataParser.NAME, ""));
    if (slot === null) {
      return;
    }
    ...
    if (DataParser.DISPLAY_FRAME in rawData) {
      displayTimeline = this._parseTimeline(rawData, null, DataParser.DISPLAY_FRAME, 20, 0, 0, this._parseSlotDisplayFrame);
    } else {
      displayTimeline = this._parseTimeline(rawData, null, DataParser.FRAME, 20, 0, 0, this._parseSlotDisplayFrame);
    }
    if (DataParser.COLOR_FRAME in rawData) {
      colorTimeline = this._parseTimeline(rawData, null, DataParser.COLOR_FRAME, 21, 1, 1, this._parseSlotColorFrame);
    } else {
      colorTimeline = this._parseTimeline(rawData, null, DataParser.FRAME, 21, 1, 1, this._parseSlotColorFrame);
    }
    ...
    if (frameCount > 0) {
      if (DataParser.CURVE in rawData) {
        ...
        for (let i = 0; i < sampleCount; ++i) {
          this._frameArray[frameOffset + 3 + i] = Math.round(this._helpArray[i] * 1e4);
        }
      } else {
        const noTween = -2;
        let tweenEasing = noTween;
        if (DataParser.TWEEN_EASING in rawData) {
          tweenEasing = _ObjectDataParser._getNumber(rawData, DataParser.TWEEN_EASING, noTween);
        }
        if (tweenEasing === noTween) {
          ...
          this._frameArray[
            frameOffset + 2
            /* BinaryOffset.FrameTweenEasingOrCurveSampleCount */
          ] = Math.round(tweenEasing * 100 - 100);
        }
      }
    } else {
      this._frameArray.length += 1;
  ...
  _parseSingleValueFrame(rawData, frameStart, frameCount) {
    ...
    switch (this._frameValueType) {
      case 0: {
        ...
        this._frameArray.length += 1;
        this._frameArray[frameOffset + 1] = _ObjectDataParser._getNumber(rawData, DataParser.VALUE, this._frameDefaultValue);
        break;
      }
      case 1: {
        ...
        this._frameIntArray[frameValueOffset] = Math.round(_ObjectDataParser._getNumber(rawData, DataParser.VALUE, this._frameDefaultValue) * this._frameValueScale);
        break;
      }
      case 2: {
        frameOffset = this._parseTweenFrame(rawData, frameStart, frameCount);
        ...
        this._frameFloatArray[frameValueOffset] = _ObjectDataParser._getNumber(rawData, DataParser.VALUE, this._frameDefaultValue) * this._frameValueScale;
        break;
      }
    }
    return frameOffset;
  ...
  _parseDoubleValueFrame(rawData, frameStart, frameCount) {
    ...
    switch (this._frameValueType) {
      case 0: {
        ...
        this._frameArray[frameOffset + 1] = _ObjectDataParser._getNumber(rawData, DataParser.X, this._frameDefaultValue);
        this._frameArray[frameOffset + 2] = _ObjectDataParser._getNumber(rawData, DataParser.Y, this._frameDefaultValue);
        break;
      }
      case 1: {
        frameOffset = this._parseTweenFrame(rawData, frameStart, frameCount);
        ...
        this._frameIntArray[frameValueOffset] = Math.round(_ObjectDataParser._getNumber(rawData, DataParser.X, this._frameDefaultValue) * this._frameValueScale);
        this._frameIntArray[frameValueOffset + 1] = Math.round(_ObjectDataParser._getNumber(rawData, DataParser.Y, this._frameDefaultValue) * this._frameValueScale);
        break;
      }
      case 2: {
        frameOffset = this._parseTweenFrame(rawData, frameStart, frameCount);
        ...
        this._frameFloatArray[frameValueOffset] = _ObjectDataParser._getNumber(rawData, DataParser.X, this._frameDefaultValue) * this._frameValueScale;
        this._frameFloatArray[frameValueOffset + 1] = _ObjectDataParser._getNumber(rawData, DataParser.Y, this._frameDefaultValue) * this._frameValueScale;
        break;
      }
    }
    return frameOffset;
  ...
  _parseActionFrame(frame, frameStart, frameCount) {
    ...
    for (let i = 0; i < actionCount; ++i) {
      this._frameArray[frameOffset + 0 + 2 + i] = frame.actions[i];
    }
    return frameOffset;
  }
  _parseZOrderFrame(rawData, frameStart, frameCount) {
    ...
    if (DataParser.Z_ORDER in rawData) {
      ...
      if (rawZOrder.length > 0) {
        ...
        for (let i2 = 0; i2 < unchanged.length; ++i2) {
          unchanged[i2] = 0;
        }
        for (let i2 = 0; i2 < slotCount; ++i2) {
          zOrders[i2] = -1;
        }
        let originalIndex = 0;
        let unchangedIndex = 0;
        for (let i2 = 0, l = rawZOrder.length; i2 < l; i2 += 2) {
          const slotIndex = rawZOrder[i2];
          const zOrderOffset = rawZOrder[i2 + 1];
  ...
  _parseBoneAllFrame(rawData, frameStart, frameCount) {
    ...
    if (DataParser.TRANSFORM in rawData) {
      this._parseTransform(rawData[DataParser.TRANSFORM], this._helpTransform, 1);
    }
    ...
    this._prevClockwise = _ObjectDataParser._getNumber(rawData, DataParser.TWEEN_ROTATE, 0);
  ...
  _parseBoneTranslateFrame(rawData, frameStart, frameCount) {
    ...
    let frameFloatOffset = this._frameFloatArray.length;
    this._frameFloatArray.length += 2;
    this._frameFloatArray[frameFloatOffset++] = _ObjectDataParser._getNumber(rawData, DataParser.X, 0);
    this._frameFloatArray[frameFloatOffset++] = _ObjectDataParser._getNumber(rawData, DataParser.Y, 0);
    return frameOffset;
  }
  _parseBoneRotateFrame(rawData, frameStart, frameCount) {
    let rotation = _ObjectDataParser._getNumber(rawData, DataParser.ROTATE, 0) * Transform.DEG_RAD;
    if (frameStart !== 0) {
      if (this._prevClockwise === 0) {
        rotation = this._prevRotation + Transform.normalizeRadian(rotation - this._prevRotation);
      } else {
    ...
    this._prevClockwise = _ObjectDataParser._getNumber(rawData, DataParser.CLOCK_WISE, 0);
    this._prevRotation = rotation;
    const frameOffset = this._parseTweenFrame(rawData, frameStart, frameCount);
    let frameFloatOffset = this._frameFloatArray.length;
    this._frameFloatArray.length += 2;
    this._frameFloatArray[frameFloatOffset++] = rotation;
    this._frameFloatArray[frameFloatOffset++] = _ObjectDataParser._getNumber(rawData, DataParser.SKEW, 0) * Transform.DEG_RAD;
    return frameOffset;
  }
  _parseBoneScaleFrame(rawData, frameStart, frameCount) {
    ...
    let frameFloatOffset = this._frameFloatArray.length;
    this._frameFloatArray.length += 2;
    this._frameFloatArray[frameFloatOffset++] = _ObjectDataParser._getNumber(rawData, DataParser.X, 1);
    this._frameFloatArray[frameFloatOffset++] = _ObjectDataParser._getNumber(rawData, DataParser.Y, 1);
    return frameOffset;
  }
  _parseSlotDisplayFrame(rawData, frameStart, frameCount) {
    ...
    if (DataParser.VALUE in rawData) {
      this._frameArray[frameOffset + 1] = _ObjectDataParser._getNumber(rawData, DataParser.VALUE, 0);
    } else {
      this._frameArray[frameOffset + 1] = _ObjectDataParser._getNumber(rawData, DataParser.DISPLAY_INDEX, 0);
    }
  ...
  _parseSlotDeformFrame(rawData, frameStart, frameCount) {
    ...
    const offset = _ObjectDataParser._getNumber(rawData, DataParser.OFFSET, 0);
    const vertexCount = this._intArray[
      this._mesh.geometry.offset + 0
      /* BinaryOffset.GeometryVertexCount */
    ];
    ...
    if (weight !== null) {
      ...
      iB = weight.offset + 2 + weight.bones.length;
    } else {
  ...
  _parseIKConstraintFrame(rawData, frameStart, frameCount) {
    ...
    this._frameIntArray.length += 2;
    this._frameIntArray[frameIntOffset++] = _ObjectDataParser._getBoolean(rawData, DataParser.BEND_POSITIVE, true) ? 1 : 0;
    this._frameIntArray[frameIntOffset++] = Math.round(_ObjectDataParser._getNumber(rawData, DataParser.WEIGHT, 1) * 100);
    return frameOffset;
  }
    ...
    if (typeof rawData === "string") {
      ...
      for (const rawAction of rawData) {
        ...
        if (DataParser.GOTO_AND_PLAY in rawAction) {
          action.type = 0;
          action.name = _ObjectDataParser._getString(rawAction, DataParser.GOTO_AND_PLAY, "");
        } else {
          if (DataParser.TYPE in rawAction && typeof rawAction[DataParser.TYPE] === "string") {
            ...
            action.type = _ObjectDataParser._getNumber(rawAction, DataParser.TYPE, type);
          }
          action.name = _ObjectDataParser._getString(rawAction, DataParser.NAME, "");
        }
        if (DataParser.BONE in rawAction) {
          const boneName = _ObjectDataParser._getString(rawAction, DataParser.BONE, "");
          action.bone = this._armature.getBone(boneName);
        } else {
          action.bone = bone;
        }
        if (DataParser.SLOT in rawAction) {
          const slotName = _ObjectDataParser._getString(rawAction, DataParser.SLOT, "");
  ...
  _parseDeformFrame(rawData, frameStart, frameCount) {
    const frameFloatOffset = this._frameFloatArray.length;
    const frameOffset = this._parseTweenFrame(rawData, frameStart, frameCount);
    const rawVertices = DataParser.VERTICES in rawData ? rawData[DataParser.VERTICES] : DataParser.VALUE in rawData ? rawData[DataParser.VALUE] : null;
    const offset = _ObjectDataParser._getNumber(rawData, DataParser.OFFSET, 0);
    const vertexCount = this._intArray[
      this._geometry.offset + 0
      /* BinaryOffset.GeometryVertexCount */
    ];
  ...
  _parseTransform(rawData, transform, scale) {
    transform.x = _ObjectDataParser._getNumber(rawData, DataParser.X, 0) * scale;
    transform.y = _ObjectDataParser._getNumber(rawData, DataParser.Y, 0) * scale;
    if (DataParser.ROTATE in rawData || DataParser.SKEW in rawData) {
      transform.rotation = Transform.normalizeRadian(_ObjectDataParser._getNumber(rawData, DataParser.ROTATE, 0) * Transform.DEG_RAD);
      transform.skew = Transform.normalizeRadian(_ObjectDataParser._getNumber(rawData, DataParser.SKEW, 0) * Transform.DEG_RAD);
    } else if (DataParser.SKEW_X in rawData || DataParser.SKEW_Y in rawData) {
      transform.rotation = Transform.normalizeRadian(_ObjectDataParser._getNumber(rawData, DataParser.SKEW_Y, 0) * Transform.DEG_RAD);
      transform.skew = Transform.normalizeRadian(_ObjectDataParser._getNumber(rawData, DataParser.SKEW_X, 0) * Transform.DEG_RAD) - transform.rotation;
    }
    transform.scaleX = _ObjectDataParser._getNumber(rawData, DataParser.SCALE_X, 1);
    transform.scaleY = _ObjectDataParser._getNumber(rawData, DataParser.SCALE_Y, 1);
  }
  _parseColorTransform(rawData, color) {
    color.alphaMultiplier = _ObjectDataParser._getNumber(rawData, DataParser.ALPHA_MULTIPLIER, 100) * 0.01;
    color.redMultiplier = _ObjectDataParser._getNumber(rawData, DataParser.RED_MULTIPLIER, 100) * 0.01;
    color.greenMultiplier = _ObjectDataParser._getNumber(rawData, DataParser.GREEN_MULTIPLIER, 100) * 0.01;
    color.blueMultiplier = _ObjectDataParser._getNumber(rawData, DataParser.BLUE_MULTIPLIER, 100) * 0.01;
    color.alphaOffset = _ObjectDataParser._getNumber(rawData, DataParser.ALPHA_OFFSET, 0);
    color.redOffset = _ObjectDataParser._getNumber(rawData, DataParser.RED_OFFSET, 0);
    color.greenOffset = _ObjectDataParser._getNumber(rawData, DataParser.GREEN_OFFSET, 0);
    color.blueOffset = _ObjectDataParser._getNumber(rawData, DataParser.BLUE_OFFSET, 0);
  }
  _parseGeometry(rawData, geometry) {
    const rawVertices = rawData[DataParser.VERTICES];
    const vertexCount = Math.floor(rawVertices.length / 2);
    let triangleCount = 0;
    ...
    this._intArray[
      geometryOffset + 3
      /* BinaryOffset.GeometryWeightOffset */
    ] = -1;
    ...
    if (DataParser.TRIANGLES in rawData) {
      ...
      triangleCount = Math.floor(rawTriangles.length / 3);
      this._intArray.length += triangleCount * 3;
      for (let i = 0, l = triangleCount * 3; i < l; ++i) {
        this._intArray[geometryOffset + 4 + i] = rawTriangles[i];
      }
    }
    this._intArray[
      geometryOffset + 1
    ...
    if (DataParser.WEIGHTS in rawData) {
      ...
      const weightCount = Math.floor(rawWeights.length - vertexCount) / 2;
      ...
      if (DataParser.BONE_POSE in rawData) {
        ...
        weightBoneCount = Math.floor(rawBonePoses.length / 7);
        weightBoneIndices.length = weightBoneCount;
        for (let i = 0; i < weightBoneCount; ++i) {
          const rawBoneIndex = rawBonePoses[i * 7];
        ...
        this._helpMatrixA.copyFromArray(rawSlotPose, 0);
        for (let i = 0, iW = 0, iB = weightOffset + 2 + weightBoneCount, iV = floatOffset; i < vertexCount; ++i) {
          const iD = i * 2;
          const vertexBoneCount = this._intArray[iB++] = rawWeights[iW++];
          ...
          y = this._helpPoint.y;
          for (let j = 0; j < vertexBoneCount; ++j) {
            const rawBoneIndex = rawWeights[iW++];
        ...
        this._floatArray.length += weightCount * 3;
        for (let i = 0, iW = 0, iV = 0, iB = weightOffset + 2 + weightBoneCount, iF = floatOffset; i < weightCount; i++) {
  ...
  parseDragonBonesData(rawData, scale = 1) {
    console.assert(rawData !== null && rawData !== void 0, "Data error.");
    const version = _ObjectDataParser._getString(rawData, DataParser.VERSION, "");
    const compatibleVersion = _ObjectDataParser._getString(rawData, DataParser.COMPATIBLE_VERSION, "");
    if (DataParser.DATA_VERSIONS.indexOf(version) >= 0 || DataParser.DATA_VERSIONS.indexOf(compatibleVersion) >= 0) {
      const data = BaseObject.borrowObject(DragonBonesData);
      data.version = version;
      data.name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
      data.frameRate = _ObjectDataParser._getNumber(rawData, DataParser.FRAME_RATE, 24);
      if (data.frameRate === 0) {
        data.frameRate = 24;
      }
      if (DataParser.ARMATURE in rawData) {
        ...
        if (DataParser.STAGE in rawData) {
          data.stage = data.getArmature(_ObjectDataParser._getString(rawData, DataParser.STAGE, ""));
  ...
  parseTextureAtlasData(rawData, textureAtlasData, scale = 1) {
    console.assert(rawData !== void 0);
    if (rawData === null) {
    ...
    textureAtlasData.width = _ObjectDataParser._getNumber(rawData, DataParser.WIDTH, 0);
    textureAtlasData.height = _ObjectDataParser._getNumber(rawData, DataParser.HEIGHT, 0);
    textureAtlasData.scale = scale === 1 ? 1 / _ObjectDataParser._getNumber(rawData, DataParser.SCALE, 1) : scale;
    textureAtlasData.name = _ObjectDataParser._getString(rawData, DataParser.NAME, "");
    textureAtlasData.imagePath = _ObjectDataParser._getString(rawData, DataParser.IMAGE_PATH, "");
    if (DataParser.SUB_TEXTURE in rawData) {
      ...
      for (let i = 0, l = rawTextures.length; i < l; ++i) {
        ...
        const frameWidth = _ObjectDataParser._getNumber(rawTexture, DataParser.FRAME_WIDTH, -1);
        const frameHeight = _ObjectDataParser._getNumber(rawTexture, DataParser.FRAME_HEIGHT, -1);
        const textureData = textureAtlasData.createTexture();
        textureData.rotated = _ObjectDataParser._getBoolean(rawTexture, DataParser.ROTATED, false);
        textureData.name = _ObjectDataParser._getString(rawTexture, DataParser.NAME, "");
        textureData.region.x = _ObjectDataParser._getNumber(rawTexture, DataParser.X, 0);
        textureData.region.y = _ObjectDataParser._getNumber(rawTexture, DataParser.Y, 0);
        textureData.region.width = _ObjectDataParser._getNumber(rawTexture, DataParser.WIDTH, 0);
        textureData.region.height = _ObjectDataParser._getNumber(rawTexture, DataParser.HEIGHT, 0);
        if (frameWidth > 0 && frameHeight > 0) {
          textureData.frame = TextureData.createRectangle();
          textureData.frame.x = _ObjectDataParser._getNumber(rawTexture, DataParser.FRAME_X, 0);
          textureData.frame.y = _ObjectDataParser._getNumber(rawTexture, DataParser.FRAME_Y, 0);
   ...
   */
  static getInstance() {
    if (_ObjectDataParser._objectDataParserInstance === null) {
      _ObjectDataParser._objectDataParserInstance = new _ObjectDataParser();
    }
    return _ObjectDataParser._objectDataParserInstance;
  }
};
ObjectDataParser._objectDataParserInstance = null;
var ActionFrame = class {
  constructor() {
    this.frameStart = 0;
    this.actions = [];
  }
...
// node_modules/@md5crypt/dragonbones-pixi/lib/parser/BinaryDataParser.js
var BinaryDataParser = class _BinaryDataParser extends ObjectDataParser {
  _inRange(a, min, max) {
    return min <= a && a <= max;
  }
  _decodeUTF8(data) {
      ...
      if (_byte === EOF_byte) {
        ...
        if (utf8_bytes_needed === 0) {
          ...
          if (utf8_bytes_seen !== utf8_bytes_needed) {
            ...
            utf8_bytes_seen = 0;
            utf8_lower_boundary = 0;
            if (this._inRange(cp, lower_boundary, 1114111) && !this._inRange(cp, 55296, 57343)) {
              code_point = cp;
            } else {
              code_point = _byte;
            }
  ...
  _parseBinaryTimeline(type, offset, timelineData = null) {
    ...
    this._timeline = timeline;
    const keyFrameCount = this._timelineArrayBuffer[
      timeline.offset + 2
      /* BinaryOffset.TimelineKeyFrameCount */
    ];
    if (keyFrameCount === 1) {
      ...
      for (let i = 0, iK = 0, frameStart = 0, frameCount = 0; i < totalFrameCount; ++i) {
        if (frameStart + frameCount <= i && iK < keyFrameCount) {
          ...
          if (iK === keyFrameCount - 1) {
            ...
            frameCount = this._frameArrayBuffer[this._animation.frameOffset + this._timelineArrayBuffer[timeline.offset + 5 + iK + 1]] - frameStart;
          }
          iK++;
        }
        frameIndices[frameIndicesOffset + i] = iK - 1;
  ...
  _parseAnimation(rawData) {
    ...
    animation.duration = animation.frameCount / this._armature.frameRate;
    animation.fadeInTime = ObjectDataParser._getNumber(rawData, DataParser.FADE_IN_TIME, 0);
    animation.scale = ObjectDataParser._getNumber(rawData, DataParser.SCALE, 1);
    ...
    this._animation = animation;
    if (DataParser.ACTION in rawData) {
      animation.actionTimeline = this._parseBinaryTimeline(0, rawData[DataParser.ACTION]);
    }
    if (DataParser.Z_ORDER in rawData) {
      animation.zOrderTimeline = this._parseBinaryTimeline(1, rawData[DataParser.Z_ORDER]);
    }
    if (DataParser.BONE in rawData) {
      ...
      for (const rawTimeline of rawTimelines) {
        ...
        if (timelineOffset >= 0) {
          ...
          if (timelineType === 40 && animation.blendType !== 0) {
            timeline = BaseObject.borrowObject(AnimationTimelineData);
            const animaitonTimeline = timeline;
            animaitonTimeline.x = ObjectDataParser._getNumber(rawTimeline, DataParser.X, 0);
            animaitonTimeline.y = ObjectDataParser._getNumber(rawTimeline, DataParser.Y, 0);
          }
  ...
  _parseGeometry(rawData, geometry) {
    ...
    geometry.data = this._data;
    let weightOffset = this._intArrayBuffer[
      geometry.offset + 3
      /* BinaryOffset.GeometryWeightOffset */
    ];
    if (weightOffset < -1) {
    ...
    if (weightOffset >= 0) {
      const weight = BaseObject.borrowObject(WeightData);
      const vertexCount = this._intArrayBuffer[
        geometry.offset + 0
        /* BinaryOffset.GeometryVertexCount */
      ];
      const boneCount = this._intArrayBuffer[
        weightOffset + 0
        /* BinaryOffset.WeigthBoneCount */
      ];
      weight.offset = weightOffset;
      for (let i = 0; i < boneCount; ++i) {
        const boneIndex = this._intArrayBuffer[weightOffset + 2 + i];
        weight.addBone(this._rawBones[boneIndex]);
      }
      let boneIndicesOffset = weightOffset + 2 + boneCount;
      let weightCount = 0;
      for (let i = 0, l = vertexCount; i < l; ++i) {
  ...
  _parseArray(rawData) {
    ...
    const l5 = offsets[9];
    const l6 = offsets[11];
    const l7 = offsets.length > 12 ? offsets[13] : 0;
    ...
    const colorArray = l7 > 0 ? new Int16Array(this._binary, this._binaryOffset + offsets[12], l7 / Uint16Array.BYTES_PER_ELEMENT) : intArray;
  ...
  parseDragonBonesData(rawData, scale = 1) {
    console.assert(rawData !== null && rawData !== void 0 && rawData instanceof ArrayBuffer, "Data error.");
   ...
   */
  static getInstance() {
    if (_BinaryDataParser._binaryDataParserInstance === null) {
      _BinaryDataParser._binaryDataParserInstance = new _BinaryDataParser();
    }
    return _BinaryDataParser._binaryDataParserInstance;
  }
};
BinaryDataParser._binaryDataParserInstance = null;

// node_modules/@md5crypt/dragonbones-pixi/lib/factory/BaseFactory.js
var BaseFactory = class _BaseFactory {
  /**
  ...
  constructor(dataParser = null) {
    ...
    if (_BaseFactory._objectParser === null) {
      _BaseFactory._objectParser = new ObjectDataParser();
    }
    if (_BaseFactory._binaryParser === null) {
      _BaseFactory._binaryParser = new BinaryDataParser();
    }
    this._dataParser = dataParser !== null ? dataParser : _BaseFactory._objectParser;
  }
  _isSupportMesh() {
    return true;
  }
  ...
  _buildBones(dataPackage, armature) {
    for (const boneData of dataPackage.armature.sortedBones) {
      const bone = BaseObject.borrowObject(boneData.type === 0 ? Bone : Surface);
   ...
   * @language zh_CN
   */
  parseDragonBonesData(rawData, name = null, scale = 1) {
    const dataParser = rawData instanceof ArrayBuffer ? _BaseFactory._binaryParser : this._dataParser;
   ...
   * @language zh_CN
   */
  parseTextureAtlasData(rawData, textureAtlas, name = null, scale = 1) {
    const textureAtlasData = this._buildTextureAtlasData(null, null);
...
var BuildArmaturePackage = class {
  constructor() {
    this.dataName = "";
...
// node_modules/@md5crypt/dragonbones-pixi/lib/pixi/PixiArmatureDisplay.js
var PixiArmatureDisplay = class extends Container {
  constructor() {
    super(...arguments);
    ...
    this._debugDrawerChildren = /* @__PURE__ */ new Map();
  }
  /**
   * @inheritDoc
   */
    ...
    if (drawed || this._debugDraw) {
      ...
      if (this._debugDraw) {
        if (this._debugDrawer === null) {
          ...
          const boneDrawer2 = new Graphics();
          this._debugDrawer.addChild(boneDrawer2);
        }
        ...
        for (let i = 0, l = slots.length; i < l; ++i) {
          ...
          if (boundingBoxData) {
            let child = this._debugDrawerChildren.get(slot.name);
            if (!child) {
              child = new Graphics();
            ...
            child.clear();
            child.lineStyle(2, 16711935, 0.7);
            ...
            child.setTransform(transform.x, transform.y, transform.scaleX, transform.scaleY, transform.rotation, transform.skew, 0, slot._pivotX, slot._pivotY);
          } else {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/pixi/PixiTextureAtlasData.js
var PixiTextureAtlasData = class extends TextureAtlasData {
  constructor() {
    super(...arguments);
...
var PixiTextureData = class extends TextureData {
  constructor() {
    super(...arguments);
...
// node_modules/@md5crypt/dragonbones-pixi/lib/pixi/PixiSlot.js
var PixiSlot = class extends Slot {
  static toString() {
  ...
  _updateColor() {
    ...
    if (this._renderDisplay instanceof Sprite || this._renderDisplay instanceof SimpleMesh) {
      const color = (Math.round(this._colorTransform.redMultiplier * 255) << 16) + (Math.round(this._colorTransform.greenMultiplier * 255) << 8) + Math.round(this._colorTransform.blueMultiplier * 255);
    ...
    if (this._displayIndex >= 0 && this._display !== null && currentTextureData !== null) {
      ...
      if (renderTexture !== null) {
        if (this._geometryData !== null) {
          ...
          const floatArray = data.floatArray;
          const vertexCount = intArray[
            this._geometryData.offset + 0
            /* BinaryOffset.GeometryVertexCount */
          ];
          const triangleCount = intArray[
            this._geometryData.offset + 1
            /* BinaryOffset.GeometryTriangleCount */
          ];
          let vertexOffset = intArray[
            this._geometryData.offset + 2
            /* BinaryOffset.GeometryFloatOffset */
          ];
          if (vertexOffset < 0) {
            vertexOffset += 65536;
          ...
          for (let i = 0; i < triangleCount * 3; ++i) {
            indices[i] = intArray[this._geometryData.offset + 4 + i];
          }
  ...
  _updateMesh() {
    ...
    if (weightData !== null) {
      ...
      let weightFloatOffset = intArray[
        weightData.offset + 1
        /* BinaryOffset.WeigthFloatOffset */
      ];
      ...
      for (let i = 0, iD = 0, iB = weightData.offset + 2 + bones.length, iV = weightFloatOffset, iF = 0; i < vertexCount; ++i) {
  ...
  _updateTransform() {
    ...
    if (this._renderDisplay === this._rawDisplay || this._renderDisplay === this._meshDisplay) {
      ...
      this._renderDisplay.setTransform(x, y, transform.scaleX * this._textureScale, transform.scaleY * this._textureScale, transform.rotation, -transform.skew, 0);
    } else {
...
// node_modules/@md5crypt/dragonbones-pixi/lib/pixi/PixiFactory.js
var PixiFactory = class _PixiFactory extends BaseFactory {
  /**
   * @inheritDoc
   */
  constructor(dataParser = null) {
    super(dataParser);
    if (_PixiFactory._dragonBonesInstance === null) {
      const eventManager = new PixiArmatureDisplay();
      _PixiFactory._dragonBonesInstance = new DragonBones(eventManager);
    }
    this._dragonBones = _PixiFactory._dragonBonesInstance;
  }
  /*
   ...
   */
  static get factory() {
    if (_PixiFactory._factory === null) {
      _PixiFactory._factory = new _PixiFactory(null);
    }
    return _PixiFactory._factory;
  }
  /**
   ...
   * @language zh_CN
   */
  buildArmatureDisplay(armatureName, options = {}) {
    const armature = this.buildArmature(armatureName, options.dragonBonesName, options.skinName, options.textureAtlasName);
    if (armature !== null) {
      if (options.clock === void 0) {
        this._dragonBones.clock.add(armature);
      } else if (options.clock) {
        armature.clock = options.clock;
      }
      return armature.display;
    }
    if (options.throwOnError) {
      throw new Error(`failed to create armature "${armatureName}"`);
    }
    return null;
  }
  /**
...
//# sourceMappingURL=@md5crypt_dragonbones-pixi.js.map
